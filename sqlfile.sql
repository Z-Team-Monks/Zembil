...
--shops
-- INSERT INTO shops("IsApproved","OwnerId","ShopName","BuildingName","PhoneNumber1","PhoneNumber2","CategoryId","ShopLocationId","Description") VALUES (true,'2','Sammy Handmade','Lucky Building',+251115539775,+251115539776,9,1,'We deliver traditional handmade products');
-- INSERT INTO shops("IsApproved","OwnerId","ShopName","BuildingName","PhoneNumber1","PhoneNumber2","CategoryId","ShopLocationId","Description") VALUES (false,'2','Legend Electrical Excellence','Unknown',+251911221931,+251911221932,1,2,'We deliver brand and original electronics products with affordable price');
-- INSERT INTO shops("IsApproved","OwnerId","ShopName","BuildingName","PhoneNumber1","PhoneNumber2","CategoryId","ShopLocationId","Description") VALUES (true,'3','YAKAMOZ Men''s Wear','Lucky Building',+251936516126,+251936516125,5,3,'We deliver comfortable, long live and brand original men''s cloths.');
-- INSERT INTO shops("IsApproved","OwnerId","ShopName","BuildingName","PhoneNumber1","PhoneNumber2","CategoryId","ShopLocationId","Description") VALUES (true,'4','Naty Computer and Laptop store','Morning Star Mall',+25111549775,+251115639776,3,4,'We deliver brand and original laptops and tablets with affordable price, there is a discount for campus students.');
-- INSERT INTO shops("IsApproved","OwnerId","ShopName","BuildingName","PhoneNumber1","PhoneNumber2","CategoryId","ShopLocationId","Description") VALUES (false,'5','HM Furniture','Unknown',+251911244481,+251911244483,10,5,'We deliver original , comfortable dubai made furniture');
-- INSERT INTO shops("IsApproved","OwnerId","ShopName","BuildingName","PhoneNumber1","PhoneNumber2","CategoryId","ShopLocationId","Description") VALUES (true,'5','J Cosmetics','Zerihun',+251930071232,+251930071231,8,6,'We offer the perfect natural Himalayan cosmetic products at an affordable price.');
-- INSERT INTO shops("IsApproved","OwnerId","ShopName","BuildingName","PhoneNumber1","PhoneNumber2","CategoryId","ShopLocationId","Description") VALUES (true,'4','Lili Brand Shoe','Lucky Building',+251115539775,+251115539776,7,1,'We deliver Rubber sole,Platform measures ,approximately Textile and leather shoe.');
